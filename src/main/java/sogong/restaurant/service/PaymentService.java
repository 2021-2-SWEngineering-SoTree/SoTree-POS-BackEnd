...
public class PaymentService {
    ...
    @Autowired
    private final MenuStatisticRepository menuStatisticRepository;
    @Autowired
    private final PayStatisticRepository payStatisticRepository;
    ...
    public String combinePay(String payTime, String method, int price, Long branchId) {
        ...
        if (managerRepository.findById(branchId).isEmpty()) {
            throw new NoSuchElementException("존재하지 않는 가게입니다.");
        }
    ...
    public Optional<Payment> getPaymentByOrder(MenuOrder menuOrder) {
        return paymentRepository.findByMenuOrder(menuOrder);
    }
